...
# start sooperlooper
/usr/bin/sooperlooper -L auto.slsess -p 9951 -l 1 -c 1 -t 120 &
...
jack_connect system:capture_1 sooperlooper:common_in_2 || (echo "error connecting audio (1)"; echo "sleep 5"; sleep 5 ; jack_connect system:capture_1 sooperlooper:common_in_2)
